    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="" src="images/logo.png"><span>可口后台管理</span></p>
                </div>
                <div id="personInfor">
                    <p id="userName">杨鹏</p>
                    <p>
                 ...
                 <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="sour">
                        <div class="check-div form-inline">
                        	...
                        	<button class="btn btn-white btn-xs ">查询商品 </button>                         	                  
                        </div>                      
                        <div class="data-div">
                                ...
                                <div id="collapseSystem" class="collapse in" aria-expanded="true">
                                    <div class="row">
                                        ...
                                        <div id="topBD" onClick="changeA()" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 levl2" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseAccount" aria-expanded="true" aria-controls="collapseOne">
                                            <span onClick="changeB()" id="topB" class="glyphicon glyphicon-triangle-bottom"></span> <span>点击查看所有商品信息</span>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                    ...
                    <div role="tabpanel" class="tab-pane" id="char">
                        ...
                        <div class="check-div">
                            <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addChar">添加订单</button>
                           	<select  class="btn btn-white btn-xs ">
                        		<option>订单类别</option>
                        		<option>1</option>
                        		<option>2</option>
                        	...
                        	<select  class="btn btn-white btn-xs ">
                        	 ...
                        	 <button class="btn btn-white btn-xs ">发货</button>  
                        </div>
                        <div class="data-div">
                            <div class="row tableHeader">
                                <div class="col-xs-1 ">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label for="sLink" class="col-xs-3 control-label">订单号：</label>
                                            <div class="col-xs-6 ">
